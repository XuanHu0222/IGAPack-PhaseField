...
Mater.E_frac = Mater.E / (1.0-Mater.nu^2)  % Plane Strain
...
Integ = struct;
Integ.nstep=201; % Number of Displacement steps
...
Integ.numStepsLimit = 201;
Integ.nprint = 10; % Printing the results after how many steps
end