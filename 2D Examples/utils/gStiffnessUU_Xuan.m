function [stiffkUU, elemRef] = gStiffnessUU_Xuan(PHTelem,sizeBasis,numberElements,dgdx,shape,Fract,Mater,volume,tdisp,geometry)
        ...
        if isempty(PHTelem{indexPatch}(i).children)
            ...
            for ii=1:ngaussX
                for jj=1:ngaussY
                    ...
                    localkUU=localkUU+coeff.*(Bu'*D).*volume(elementCounter,kgauss);
                end %jgauss
            end %igauss
